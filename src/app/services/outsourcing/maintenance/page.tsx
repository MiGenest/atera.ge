    ...
    <main className="min-h-screen bg-[#0B1B2B] text-white">
      ...
      <section className="mx-auto max-w-6xl px-4 pt-14 pb-10">
        <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur p-8 md:p-10">
          <p className="text-white/70 text-sm">სერვისები • ტექნიკური მხარდაჭერა</p>

          <h1 className="mt-3 text-3xl md:text-5xl font-bold tracking-tight">
            მხარდაჭერა, რომელიც დროზე რეაგირებს
          </h1>

          <div className="mt-4 rounded-2xl border border-white/10 bg-[#0B1B2B]/60 p-5">
            <p className="text-white/90 text-sm md:text-base leading-relaxed">
              ვაგვარებთ პრობლემებს სწრაფად და ვაკეთებთ პრევენციას —
              რომ შეფერხებები მინიმუმამდე დავიყვანოთ.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-14">
        <div className="grid gap-4 md:grid-cols-3">
          <Card title="Help Desk" text="ბილეთები, პრიორიტეტები, SLA და კონტროლირებადი პროცესი." />
          <Card title="სერვერები & ქსელი" text="მონიტორინგი, ბექაპები, განახლებები და სტაბილურობა." />
          <Card title="სამუშაო ადგილები" text="PC/Mac, პრინტერები, Wi-Fi, მომხმარებლების მხარდაჭერა." />
        </div>
      </section>
