    ...
    return (
      <section id="clients" className="py-20 px-4 md:px-10 lg:px-20 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          {/* სათაური */}
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800">მომხმარებელთა მიმოხილვები</h2>
          <p className="text-lg text-gray-600 mt-2">რას ფიქრობენ ჩვენს შესახებ ჩვენი კლიენტები</p>
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-100 p-6 rounded-lg shadow-md hover:shadow-xl transition">
              ...
              <div className="mt-4 flex items-center justify-center">
                <img src="/guy1.png" alt="მომხმარებელი" className="w-12 h-12 rounded-full object-cover" />
            ...
            <div className="bg-gray-100 p-6 rounded-lg shadow-md hover:shadow-xl transition">
              ...
              <div className="mt-4 flex items-center justify-center">
                <img src="/lady.png" alt="მომხმარებელი" className="w-12 h-12 rounded-full object-cover" />
                <div className="ml-4 text-left">
            ...
            <div className="bg-gray-100 p-6 rounded-lg shadow-md hover:shadow-xl transition">
              ...
              <div className="mt-4 flex items-center justify-center">
                <img src="/guy2.png" alt="მომხმარებელი" className="w-12 h-12 rounded-full object-cover" />
                <div className="ml-4 text-left">
